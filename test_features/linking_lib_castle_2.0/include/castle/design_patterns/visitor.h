#ifndef CASTLE_DESIGN_PATTERNS_VISITOR_H
#define CASTLE_DESIGN_PATTERNS_VISITOR_H
...
/// Usage: using ShapeVisitor = visitor<Class1&, Class2&, CASTLE_CONST Class3&>;
...
/// @tparam T1 The visit parameter type (value, ref, or CASTLE_CONST ref).
// ----------------------------------------------------------------
...
#endif // CASTLE_DESIGN_PATTERNS_VISITOR_H
